    ...
    public String[] reorderLogFiles(String[] logs) {
        ...
        Collections.sort(stringlist, new Comparator<String>() {
            ...
            public int compare(String o1, String o2) {
                String i1 = o1.substring(o1.indexOf(" ") + 1);
                String i2 = o2.substring(o2.indexOf(" ") + 1);
